...
\newcommand\usegrid{1} %[0] put 3x3 grid over each slide mimicing matrix display
\newcommand\filledtitle{2} %[2] 0: oldschool nasa template with frametitle in line with meatball, 2: sec/subsec above title filled
\newcommand\themecolors{0}    %[0] optional: 1 = ucd colors, other = nasa colors
\newcommand\newfootercenter{0} %[0] center footer text: 0=date, 1=footercenter text
\newcommand\footercenter{new center footer text rather than short title} %use this for SBU message
\newcommand\newfooterleft{0} %[0] left footer text: 0=Author (Institute), 1=leftcenter text
...
\newcommand\titleheightfrac{0.575} %fraction height of (base of (?)) title from top (default 0.775)
% \newcommand\titlebarsingleline{1} %default 0 unless cui banner
\newcommand\cuibanner{1}
% \newcommand\cuitext{CUI//SP-EXPT//DL ONLY} %default "CUI//SP-EXPT"
\newcommand\itarnotice{1}
% \newcommand\itartextwidth{15cm} %default 15cm

%-------------------------------------------------
%LOAD CUSTOM BEAMER CLASS
\ifnum\runlocal=1%
    \newcommand\libpath{.}
\else%
    \newcommand\libpath{\string~/lib/beamer/nasa}
\fi%
\usepackage{\libpath/beamerthemenasa}
...
{
  %Column of logos on the left
  %NASA logo
  \begin{textblock*}{0cm}(-0.47cm,0.005\textheight) %Textbox width, then coords of center
    \includegraphics[height=0.175\textheight]{\libpath/Images/NASA_Meatball.png}
    \end{textblock*}

  %Artemis Logo
  \begin{textblock*}{0cm}(-0.47cm,0.2\textheight) %Textbox witdh, coords of center
  \includegraphics[height=0.175\textheight]{\libpath/Images/Artemis_logo.png}
  % \vspace{-0.4in}
  % \hspace{0.125in}\textcolor{white}{HRVIP}
  \end{textblock*}

  %Orion Logo
  \begin{textblock*}{0cm}(-0.47cm,0.4\textheight) %Textbox witdh, coords of center
    \includegraphics[height=0.175\textheight]{\libpath/Images/Orion_logo.png}
    % \vspace{-0.4in}
    % \hspace{0.125in}\textcolor{white}{HRVIP}
    \end{textblock*}
  ...
  % \includegraphics[height=\textheight]{\libpath/Images/SLS_Orange.png}
  \includegraphics[height=0.5\textheight]{\libpath/Images/Orion_ArtemisI_Selfie.png}
  \end{textblock*}
}
